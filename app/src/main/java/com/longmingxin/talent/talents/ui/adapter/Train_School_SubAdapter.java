...
public class Train_School_SubAdapter extends BaseQuickAdapter<Train_School_Data,BaseViewHolder> {
    public Train_School_SubAdapter(@LayoutRes int layoutResId, @Nullable List<Train_School_Data> data) {
        super(layoutResId, data);
    }

    @Override
    protected void convert(BaseViewHolder helper, Train_School_Data item) {

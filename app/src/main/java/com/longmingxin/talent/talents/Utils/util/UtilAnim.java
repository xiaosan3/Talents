...
public class UtilAnim {
    ...
    public static void showToUp(final View view, final View view_back,
                                final int duration) {
        if (view_back == null) {
            return;
        }
     ...
     */
    public static void showToUp(View view, View view_back) {
        showToUp(view, view_back, 250);
    }
     ...
     * @param view_back 背景遮罩
     */
    public static void hideToDown(View view, View view_back) {
        hideToDown(view, view_back, 250);
    }
}
